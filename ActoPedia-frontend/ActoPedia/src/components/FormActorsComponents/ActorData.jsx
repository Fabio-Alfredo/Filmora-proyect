    ...
    return (
        <>
            <form className="flex flex-col gap-5 w-4/5 3xl:w-3/4 items-center"   >
                <InputField nameField="Nombre" inputName={"name"} type="text" placeH="e.g. NimbusX" />
                <InputField nameField="Edad" inputName={"age"} type="text" />
                <InputField nameField='Fotografia' inputName={"image"} type='file' inputValue={image} inputOnchage={handleFileChange} />
                <div className='w-full'>
                    ...
                    <textarea className="p-3 min-w-full bg-slate-200/55 text-white font-Nunito ring-2 ring-white rounded-lg transition ease-in-out duration-200 focus:bg-slate-950/70 focus:outline-slate-950 focus:shadow-2xl focus:shadow-slate-200 "
                        name="Biografia"  type="textarea" placeholder="e.g. Actor de doblaje" />
                </div>
